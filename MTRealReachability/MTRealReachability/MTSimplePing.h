...
@interface MTSimplePing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<MTSimplePingDelegate> delegate;
...
@protocol MTSimplePingDelegate <NSObject>
